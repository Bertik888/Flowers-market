    ...
    <div class="row">
      <div class="col-3">
        <div class="action-card__items"> 
          ...
          <button class="btn action-card__button">
            Заказать
          </button>

          <div class="action-card__fast_order">
            Быстрый заказ
          </div>
...
.action-card {
  ...
  //   min-height: 543px;
  //   border: 1px solid $purple;
  //   // margin-left: 10px;      // верно ли left & right ?
  //   // margin-right: 10px;
  //   // margin-bottom: 20px;

  //   // &:last-child {
  //   //   // margin-right: 0;    // уточнить по поводу крайнего margin в карте
  //   //   // margin-bottom: 0;   // также по нижней границе
  //   // }

  //   // background-image: url(@/assets/images/actions_card/red-roses.png);
...
<div class="col-3">
  <div class="action-card__item"></div>
